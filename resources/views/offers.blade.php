...
<body>
    ...
    <section class="offerList">
        <div class="offerList-offerContainer">
            <div>
            ...
            <p class="offerList-offerContainer-bedtype">DOUBLE BED</p>
            <p class="offerList-offerContainer-beddetails">Luxury Double Bed</p>
            <p class="offerList-offerContainer-description">
            ...
            <div class="offerList-offerContainer-amenities">
                <div>
                    <div>
    ...
    <section class="popularRooms">
        <p>POPULAR LIST</p>
        <p>Popular Rooms</p>
        <div class="roomList-container roomList-container--popular">
