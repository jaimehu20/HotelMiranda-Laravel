...
<body>
    ...
    <section class="aboutUs">
        <div class="aboutUs-container">
            ...
            <div class="aboutUs-team">
                <div>
                    <img src="{{asset('assets/icons/persons.png')}}"/>
                    <img src="{{asset('assets/icons/persons2.png')}}"/>
                    <p>Strong Team</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                </div>  
                <img src="{{asset('assets/images/luxuryRoom.jpg')}}"/>
                <img src="{{asset('assets/images/luxuryRoom.jpg')}}"/>
                <div class="aboutUs-team-room">
                    <img src="{{asset('assets/icons/box.png')}}"/>
                    <p>Luxury Room</p>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p>
                </div> 
            </div>
                    ...
                    @foreach ($rooms as $room)
                        <div class="swiper-slide">
                            <div class="swiper-icons">
                                <img src="{{asset('assets/icons/bedIcon.png')}}"/>
                                <img src="{{asset('assets/icons/wifIcon.png')}}"/>
                                <img src="{{asset('assets/icons/carIcon.png')}}"/>  
                                <img src="{{asset('assets/icons/flake.png')}}"/>    
                                <img src="{{asset('assets/icons/gym.png')}}"/>    
                                <img src="{{asset('assets/icons/nosmoke.png')}}"/>    
                                <img src="{{asset('assets/icons/cocktail.png')}}"/>  
                            </div>
                            <img src="{{asset('assets/images/room1.jpg')}}"/>
    ...
    <section class="introVideo">
        ...
        <div>
            <video src="{{asset('assets/images/video.mp4#t=15,75')}}" controls></video>
        </div>
    </section>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                    <div class="features-container">
                        <img src="{{asset('assets/icons/like.png')}}"/>
                        <h1> 01</h1>
                    </div>
              ...
              <div class="swiper-slide">
                <div class="features-container">
                    <img src="{{asset('assets/icons/ubication.png')}}"/>
                    <h1>03</h1>
                </div>
              ...
              <div class="swiper-slide">
                <div class="features-container">
                    <img src="{{asset('assets/icons/cancellation.png')}}"/>
                    <h1> 04</h1>
                </div>
              ...
              <div class="swiper-slide">
                <div class="features-container">
                    <img src="{{asset('assets/icons/payment.png')}}"/>
                    <h1>05</h1>
                </div>
              ...
              <div class="swiper-slide">
                <div class="features-container">
                    <img src="{{asset('assets/icons/discount.png')}}"/>
                    <h1> 06</h1>
                </div>
    ...
    <section class="menu">
        <img src="{{asset('assets/icons/donut.png')}}"/>
                ...
                <div class="swiper-slide">
                    <div class="menu-table">
                        <div class="menu-table-item">
                            <img src="{{asset('assets/images/bacon.png')}}"/>
                        </div>
                        <div class="menu-table-item">
                            <p>Eggs & Bacon</p>
                        ...
                        <div class="menu-table-item">
                            <img src="{{asset('assets/images/chia.jpg')}}"/>
                        </div>
                        <div class="menu-table-item">
                            <p>Chia Oatmeal</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.</p>
                    ...
                    <div class="menu-table menu-table--2">
                        ...
                        <div class="menu-table-item">
                            <img src="{{asset('assets/images/fruit.jpg')}}"/>
                        </div>
                        <div class="menu-table-item">
                            <p>Fruit Parfait</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.</p>
                    ...
                    <div class="menu-table menu-table--3">
                        <div class="menu-table-item">
                            <img src="{{asset('assets/images/marmalade.jpg')}}"/>
                        </div>
                        <div class="menu-table-item">
                        ...
                        <div class="menu-table-item">
                            <img src="{{asset('assets/images/cheese.jpg')}}"/>
                        </div>
                        <div class="menu-table-item">
                            <p>Cheese Plate</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adip isicing elit, sed do eiusmod tempor.</p>
        ...
        <div class="menu-food">
            <div class="swiper swiper--food">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img class="food" src="{{asset('assets/images/pizza.jpg')}}"/>
                    </div>
                    <div class="swiper-slide">
                        <img class="food" src="{{asset('assets/images/pizza.jpg')}}"/>
                    </div>
    ...
    <section class="achievements">
        <div class="achievements-container">
            <div class="achievements-item">
                <img src="{{asset('assets/icons/rocket.png')}}"/>
                <p>84k₊</p>
                <p>Projects are Completed</p>
            </div>
            <div class="achievements-item">
                <img src="{{asset('assets/icons/employees.png')}}"/>
                <p>10M₊</p>
                <p>Active Backers Around World</p>
            </div>
            <div class="achievements-item">
                <img src="{{asset('assets/icons/graph.png')}}"/>        
                <p>02k₊</p>
                <p>Categories Served</p>
            </div>
            <div class="achievements-item">
                <img src="{{asset('assets/icons/book.png')}}"/>
                <p>100M₊</p>
    ...
    <footer class="footer">
        ...
        <div class="footer-contact-section">
            ...
            <div class="footer-contactData">
                ...
                <div>
                    <img src="{{asset('assets/icons/message.png')}}"/>
                    <div>
                        <p>Fax</p>
                        <p>+987 876 765 76 577</p>
                    </div>
                ...
                <div>
                    <img src="{{asset('assets/icons/map.png')}}"/>
                    <div>
                        <p>Location</p>
